...
#define AMOUNT_OF_COMMANDS_1		7
#define AMOUNT_OF_COMMANDS_2		6
...
uchar LCD_INIT_COMMANDS_PART_1[AMOUNT_OF_COMMANDS_1] = {
	SCROL_CTL,
	SET_MIRROR_COL,
	SET_MIRROR_ROW,
	ALL_PIXEL_ON,
...
uchar LCD_INIT_COMMANDS_PART_2[AMOUNT_OF_COMMANDS_2] = {
...
void SetupADC()
{
	...
	ADC12CTL1 =
			ADC12CONSEQ_1	//seq conversion mode
			+ ADC12SHS_1
	...
	ADC12MCTL0 =
			ADC12SREF_1
			 + ADC12INCH_10
			 + ADC12EOS;	//ADC i/p ch A10 = temp sense i/p
...
int main(void)
{
	...
	*/
	...
	while (1)
	{
		...
		__delay_cycles(900000);	//32ms delay. This delay can be replaced with other application tasks
	}
